...
const HERO_THEMES: Record<HeroType, CardTheme> = {
  ...
  'superman': {
    bg: 'linear-gradient(160deg, #1d4ed8 0%, #1e3a8a 40%, #dc2626 100%)',
    border: '#ef4444',
    ink: '#ffffff',
    inkSoft: '#93c5fd',
  ...
  'thor': {
    bg: 'linear-gradient(160deg, #1e3a5f 0%, #0c1929 40%, #6d28d9 100%)',
    border: '#60a5fa',
    ink: '#ffffff',
    inkSoft: '#93c5fd',
    glow: 'rgba(96, 165, 250, 0.55)',
    statBar: '#60a5fa',
    badge: 'rgba(96, 165, 250, 0.25)',
  },
  'wonder-woman': {
    bg: 'linear-gradient(160deg, #92400e 0%, #78350f 40%, #b91c1c 100%)',
    border: '#fbbf24',
    ink: '#ffffff',
    inkSoft: '#fde68a',
  ...
  'black-widow': {
    bg: 'linear-gradient(160deg, #0a0a0a 0%, #1c1917 45%, #7f1d1d 100%)',
    border: '#dc2626',
    ink: '#ffffff',
    inkSoft: '#d4d4d8',
  ...
  'scarlet-witch': {
    bg: 'linear-gradient(160deg, #7f1d1d 0%, #581c87 50%, #1e1b4b 100%)',
    border: '#c084fc',
    ink: '#ffffff',
    inkSoft: '#e9d5ff',
    glow: 'rgba(192, 132, 252, 0.55)',
    statBar: '#c084fc',
    badge: 'rgba(192, 132, 252, 0.25)',
  },
};
